...
void cartesian_to_sh_ij_vector(double*, double*, int, int, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*, FILES);
//void two_centre_cartesian_to_sh_ij_vector(double*, double*, int, int, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*, FILES);
//void two_centre_vector_cartesian_to_sh_shell_ij(double*, double*, int, int, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*, FILES);
...
void four_centre_cartesian_to_sh_ijkl(double*, double*, int, int, int, int, SHELL*, JOB_PARAM*, FILES);
*/

void cartesian_to_sh_ijij(double*, double*, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*, FILES);

//void four_centre_cartesian_to_sh_ijij(double*, double*, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*, FILES);
//void four_centre_cartesian_to_sh_atom_ijkl_screen(double*, double*, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*, FILES);

void cartesian_to_sh_ijkl(double*, double*, int, int, int, int, SHELL*, JOB_PARAM*, FILES);
//void four_centre_cartesian_to_sh_ijkl(double*, double*, int, int, int, int, SHELL*, JOB_PARAM*, FILES);
//void four_centre_cartesian_to_sh_atom_ijkl(double*, double*, int, int, int, int, SHELL*, JOB_PARAM*, FILES);

//void two_centre_cartesian_to_sh(double*, double*, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*, FILES);

//void two_centre_cartesian_to_sh_shell_ij_complex(Complex*, Complex*, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*,FILES);
void four_centre_cartesian_to_sh_ijij_complex(Complex*, Complex*, int, int, int, int, int, int, int, int, SHELL*, JOB_PARAM*,FILES);

//void three_centre_cartesian_to_sh_shell_ax_reversed(double*, double*, int, int, int, int, int, int, int, int, int, int, int, int, int, SHELL*, SHELL*, JOB_PARAM*, FILES);
