#ifndef DENSITY_MATRIX1H
#define DENSITY_MATRIX1H
...
//void density_matrix_crystal2(FERMI*, double*, double*, KPOINT_TRAN*, int*, REAL_LATTICE*, REAL_LATTICE_TABLES*, PAIR_TRAN*, ATOM_TRAN*, ATOM*, SHELL*, SYMMETRY*, JOB_PARAM*, FILES);
//void density_matrix_crystal2(FERMI*, double*, double*, KPOINT_TRAN*, int*, REAL_LATTICE*, PAIR_TRAN*, ATOM_TRAN*, ATOM*, SHELL*, SYMMETRY*, JOB_PARAM*, FILES);

//void reduced_density_matrix_crystal(FERMI*, double*, KPOINT_TRAN*, REAL_LATTICE*, REAL_LATTICE_TABLES*, PAIR_TRAN*, ATOM_TRAN*, ATOM*, SHELL*, SYMMETRY*, JOB_PARAM*,FILES);
