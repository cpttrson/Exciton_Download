...
void bse_hamiltonian(int*, int*, double*, double*, double*, double*, FERMI*, ATOM_TRAN*, ATOM*, ATOM*, SHELL*, GAUSSIAN*, CRYSTAL*, SYMMETRY*, REAL_LATTICE*, REAL_LATTICE_TABLES*, RECIPROCAL_LATTICE*, JOB_PARAM*, FILES);

void rpa_molecule(FERMI*, ATOM*, ATOM_TRAN*_p, SHELL*, GAUSSIAN*, ATOM*, SHELL*, GAUSSIAN*, CRYSTAL*, SYMMETRY*, REAL_LATTICE*, REAL_LATTICE_TABLES*, RECIPROCAL_LATTICE*, JOB_PARAM*, FILES);
...
void generate_temp4(double*, double*, FERMI*, ATOM*, JOB_PARAM*, FILES);
...
void hamiltonian_in_core_screened_ij_ab(int*, int*, int*, int*, int*, double*, double*, double*, double*, ATOM*, FERMI*, JOB_PARAM*, FILES);
...
void self_energy_diagonal(int*, int*, int*, int*, int*, double*, double*, ATOM*, FERMI*, JOB_PARAM*, FILES);
